...
const css = `
  ...
  .oc-td-normal { font-weight: 500; color: #444; }
      ...
      <div className="oc-page">
        ...
        <div className="oc-content-wrap">
          ...
          <header className="oc-navbar">
            <div>
              <div className="oc-topbar-title">Escolas</div>
              <div className="oc-topbar-sub">Escolas cadastradas no sistema</div>
            </div>
          ...
          <main className="oc-main">
            <div className="oc-content">
              <div className="oc-top-bar">
                <h2 className="oc-title">ESCOLAS CADASTRADAS</h2>
                ...
                <button className="oc-btn-cadastrar" onClick={() => router.push("/cadastro_escola")}>
                  CADASTRAR ESCOLA
                </button>
              </div>
              ...
              <div className="oc-table-wrap">
                <table className="oc-table">
                  ...
                  <tbody>
                    {loading ? (
                      <tr><td colSpan={4} className="oc-feedback">Carregando escolas...</td></tr>
                    ) : error ? (

...
const css = `
  ...
  .oc-td-time { font-weight: 500; color: #444; }
  ...
  .oc-btn-mapa { background: none; border: none; cursor: pointer; font-size: 12px; font-weight: 800; color: #01233F; letter-spacing: 0.5px; text-transform: uppercase; padding: 0; font-family: "Segoe UI", Tahoma, Geneva, Verdana, sans-serif; transition: opacity 0.15s; }
  .oc-btn-mapa:hover { opacity: 0.6; }
      ...
      <div className="oc-page">
        ...
        <div className="oc-content-wrap">
          ...
          <header className="oc-navbar">
            <div>
              <div className="oc-topbar-title">Rotas</div>
              <div className="oc-topbar-sub">Rotas cadastradas no sistema</div>
            </div>
          ...
          <main className="oc-main">
            <div className="oc-content">
              <div className="oc-top-bar">
                <h2 className="oc-title">ROTAS CADASTRADAS</h2>
                ...
                <button className="oc-btn-cadastrar" onClick={() => router.push("/cadastro_rota")}>
                  CADASTRAR ROTA
                </button>
                <button className="oc-btn-cadastrar" onClick={() => router.push("/lista_escolas")}>
                  GERENCIAR ESCOLAS
                </button>
              </div>
              ...
              <div className="oc-table-wrap">
                <table className="oc-table">
                  ...
                  <tbody>
                    {loading ? (
                      <tr><td colSpan={5} className="oc-feedback">Carregando rotas...</td></tr>
                    ) : error ? (
                      ...
                      filtered.reverse().map((r) => (
                        <tr key={r.id}>
                          ...
                          <td className="oc-td-bold">{r.end_point}</td>

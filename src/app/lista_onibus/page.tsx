...
export default function OnibusCadastradosPage() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      if (success) alert("✓ Ônibus excluído com sucesso!");
    } catch {
      ...
      <div className="layout">
        ...
        <div className="content">
          <header className="topbar">
            <div>
              <div className="topbar-title">Frota de Ônibus</div>
              <div className="topbar-sub">Ônibus cadastrados no sistema</div>
            </div>
            ...
            <div className="top-bar">
              ...
              <div className="search-wrap">
                ...
                <input
                  ...
                  placeholder="Buscar por placa, rota ou motorista..."
                  value={search}
                  onChange={(e) => setSearch(e.target.value)}
                />
              </div>
              <button className="btn-primary" onClick={() => router.push("/cadastro_onibus")}>
                Cadastrar ônibus
              </button>
            </div>
                  ...
                  {error ? (
                    ...
                    filtered.map((v) => (
                      <tr key={v.id}>
                        ...
                        <td className="td-muted">{v.route?.name || v.mainRoute || "Pendente"}</td>
                        <td className="td-muted">{v.driver?.name || "N/A"}</td>
                        <td>
                          <div className="td-ops">
                            <button className="btn-edit" onClick={() => router.push(`/editOnibus?id=${v.id}`)}>

...
export default function CadastroEscolaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ name: "", cep: "", address: "", reference_point: "" });
      setTimeout(() => router.push("/lista_escolas"), 2000);
    } catch (err: any) {
      setSubmitError(err?.message || "Erro ao cadastrar escola");
    }
  };
      ...
      <div className="layout">
        ...
        <div className="content">
          ...
          <div className="body">
            ...
            <div className="card">
              {submitSuccess && <div className="alert alert-success">✓ Escola cadastrada com sucesso! Redirecionando...</div>}

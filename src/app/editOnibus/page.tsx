...
export default function EditarOnibus() {
  ...
  useEffect(() => {
    ...
    const loadVehicle = async () => {
      ...
      if (vehicle) {
        ...
        setTimeout(() => { syncPlaca(vehicle.plate); }, 0);
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitError(null); setSubmitSuccess(false);
    if (!vehicleId) return;
    if (form.plate.length < 7) { setSubmitError("A placa deve ter exatamente 7 caracteres (ex: ABC1D23)"); return; }
    const payload = {
      ...
      <div className="layout">
        ...
        <aside className="sidebar">
          ...
          <nav className="sidebar-nav">
            ...
            <button className="nav-item active"><BusFrontIcon /> Ônibus</button>
        ...
        <div className="content">
          ...
          <header className="topbar">
            <div>
              ...
              <div className="topbar-sub">Atualize os dados do veículo</div>
            </div>
          ...
          <div className="body">
            ...
            <div className="card">
              {submitSuccess && <div className="alert alert-success">✓ Ônibus atualizado com sucesso! Redirecionando...</div>}
              ...
              <form onSubmit={handleSubmit}>
                <div className="row">
                  <div className="field">
                    ...
                    <input ref={placaRef} type="text" name="plate" className="input" placeholder="Ex: ABC1D23" maxLength={7} value={form.plate} onChange={handleChange} required />
                  </div>
                  <div className="field">
                ...
                <div className="field">
                  ...
                  <input type="text" name="mainRoute" className="input" placeholder="Ex: Ingá - Centro - Timbaúba" value={form.mainRoute} onChange={handleChange} required />
                </div>

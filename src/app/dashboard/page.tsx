        ...
        <div className="db-content">
          ...
          <header className="db-topbar">
            <div>
              ...
              <div className="db-topbar-sub">Visão geral do sistema · {new Date().toLocaleDateString("pt-BR", { weekday: "long", day: "numeric", month: "long" })}</div>
            </div>
          ...
          <div className="db-body">
            ...
            {/* ATIVIDADE RECENTE — linha separada full width */}
